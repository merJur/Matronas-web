...
const Elena = () => {
  return (
    <div>
      <p>
        Soy Elena, matrona enamorada de mi profesión y mamá de dos niños que son
        los grandes maestros de mi vida. El yoga lleva vinculado a mi vida desde
        hace más de 25 de años y ha sido esa guía interior que ha estado
        presente en todos los momentos de mi vida, pero sobre todo, en mis
        maternidades. Es por ello, me formé como instructora de yoga para el
        embarazo, el postparto y la crianza. Además mi formación es continua y
        soy asesora de lactancia materna y me formé en Medicina Tradicional
        China aplicada al embarazo, al parto y postparto. Tuve el honor de haber
