  ...
  return (
    <div className="container">
      ...
      <p  className='text-about-us' >
        ...
        vital. <br/>
        <br/>
        <strong>OM MATRONAS</strong>, nace en estos momentos de profundos cambios en la
        ...
        <strong> OM</strong> y dio lugar a todo el universo, considerándose por eso la sílaba
        sagrada, el sonido del que emergieron el resto de sonidos.<br/><br/>
        Tradicionalmente en las clases de yoga, se entona el mantra <strong> OM </strong> tres veces
        ...
        naturaleza. Por eso Patanjali dice que <strong>“OM es el camino hacia uno mismo,
        hacia lo más profundo de nuestro ser”</strong>. <br/> <br/> Y por eso, el mantra OM forma
      ...
      <br/>
      <h2 style={{textAlign:'center', marginTop:'1rem'}}>¿Qué ofrecemos?</h2>
      <br/>
      
        Queremos <strong>acompañarte</strong> a ti mujer en todo tu ciclo vital. Y es que, la
        ...
        ofrecemos <strong>servicios</strong> que cubren todas estas esferas vitales desde la
